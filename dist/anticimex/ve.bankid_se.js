(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["bankid_se"] = factory();
	else
		root["VeLib"] = root["VeLib"] || {}, root["VeLib"]["bankid_se"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Actions = function () {
		...
		_createClass(Actions, [{
			...
			key: "openIframe",
			value: function openIframe(autoStartToken) {
				return new Promise(function (resolve, reject) {
					...
					frm.setAttribute("src", "bankid:///?autostarttoken=#{autoStartToken}&redirect=null");
			...
			key: "createSignSession",
			value: function createSignSession(dUid, recipientId, personalNumber) {
